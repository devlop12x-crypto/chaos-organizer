...
### 10. Шифрование сообщений и файлов
...
### 12. Удаление сообщений (сверх/bonus ТЗ)
...
### 13. Расшифровка голосовых в текст (сверх/bonus ТЗ)
...
**Криптография:** AES (`crypto-js`) — реализация буквально по заданию проекта.
...
- Шифрование защищает содержимое от сервера и от постороннего наблюдателя, но не заменяет полноценный E2E-протокол с обменом ключами.
